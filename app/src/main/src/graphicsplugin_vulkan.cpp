...
struct DepthBuffer
{
    ...
    void TransitionLayout(CmdBuffer* cmdBuffer, VkImageLayout newLayout)
    {
        ...
        vkCmdPipelineBarrier(cmdBuffer->buf, VK_PIPELINE_STAGE_ALL_GRAPHICS_BIT, VK_PIPELINE_STAGE_ALL_GRAPHICS_BIT, 0, 0, nullptr, 0, nullptr, 1,
                             &depthBarrier);
...
#include "frag.spv"
    ...
    int64_t SelectColorSwapchainFormat(const std::vector<int64_t>& runtimeFormats) const override
    {
        ...
        constexpr int64_t SupportedColorSwapchainFormats[] = {VK_FORMAT_B8G8R8A8_SRGB, VK_FORMAT_R8G8B8A8_SRGB, VK_FORMAT_B8G8R8A8_UNORM,
                                                                           ...
                                                                           const XrSwapchainCreateInfo& swapchainCreateInfo) override
    {
        ...
        std::vector<XrSwapchainImageBaseHeader*> bases =
            swapchainImageContext.Create(m_vkDevice, &m_memAllocator, capacity, swapchainCreateInfo, m_pipelineLayout, m_shaderProgram, m_drawBuffer);
...
#define MK_OBJECT_TYPE_CASE(name)                  \
    ...
    static VKAPI_ATTR VkBool32 VKAPI_CALL debugReportThunk(VkDebugReportFlagsEXT flags, VkDebugReportObjectTypeEXT objectType, uint64_t object,
    ...
    virtual XrResult CreateVulkanInstanceKHR(XrInstance instance, const XrVulkanInstanceCreateInfoKHR* createInfo, VkInstance* vulkanInstance,
...
struct VulkanGraphicsPluginLegacy : public VulkanGraphicsPlugin
{
                                           ...
                                           VkResult* vulkanResult) override
    {
        ...
        CHECK_XRCMD(pfnGetVulkanDeviceExtensionsKHR(instance, createInfo->systemId, deviceExtensionNamesSize, &deviceExtensionNamesSize,
